...
window.VadClearCache = function () {
  // if (!chrome.hasOwnProperty("browsingData"))
  //   return;
  // if (window.clearing) {
  //   return;
  // }
...
window.VadInit = function () {
  ...
  window.VadTabUpdate = function (tabId, changeInfo, tab) {
    ...
    if (tab.url.indexOf("v.qq.com") > -1 || tab.url.indexOf("tv.sohu.com")) {
      window.VadClearCache();
    }
  };
